...
class ProsesAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProsesAdapter.ViewHolder {
            ...
            binding.apply {
                ...
                if (currentItem.status == 1) {
                    ...
                    wrapper.setOnClickListener {
                        ...
                        builder.setMessage("Apakah anda yakin ingin mengkonfirmasi pemesanan ini ?")
                            .setCancelable(false)
