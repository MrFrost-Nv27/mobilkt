    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        firebaseRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                Toast.makeText(this@ProsesActivity, "Fetch Data", Toast.LENGTH_SHORT).show()
            }

            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@ProsesActivity, "error : ${error.message}", Toast.LENGTH_SHORT).show()
            }
        ...
        binding.rvData.apply {
            ...
            layoutManager = LinearLayoutManager(this@ProsesActivity)
        }
    }
}